                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" id="text-input" type="text" name="slug" placeholder="Slug">
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
{{--                                                        </div>--}}
                                                        <textarea class="form-control" id="summary-ckeditor2" name="content_promotion" style="height: 400px"></textarea>
                                                        <script>
