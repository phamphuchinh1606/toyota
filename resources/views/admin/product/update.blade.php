                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" id="text-input" type="text" name="product_number_of_seat" placeholder="Số chỗ ngồi"
                                                    value="{{$product->product_number_of_seat}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" id="text-input" rows="3" name="product_other_information" placeholder="Thông tin khác">{{$product->product_other_information}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
