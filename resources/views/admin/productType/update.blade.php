                            ...
                            <div class="card">
                                ...
                                <form class="form-horizontal" action="{{route('admin.product_type.update',['id' => $productType->id])}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Loại Thương hiệu</label>
                                            <div class="col-md-9">
                                                <select name="vendor_id" class="form-control">
                                                    @foreach($vendors as $vendor)
                                                        <option value="{{$vendor->id}}" @if($vendor->id == $productType->vendor_id) selected @endif >{{$vendor->vendor_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
