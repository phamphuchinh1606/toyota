...
<head>
    ...
    <script id="facebook-jssdk" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&amp;version=v2.11"></script><script type="text/javascript">
        ...
        Haravan.theme = {"name":"suplo_car_accessories update 29/10/2018","id":1000394224,"role":"main"};
    ...
    <script async="" src="{{asset('js/guest/plugin/haravan-analytics.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{asset('js/guest/plugin/jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('js/guest/plugin/modernizr.min.js')}}" type="text/javascript"></script>

    <script src="{{asset('js/guest/plugin/owl.carousel.min.js')}}"></script>


    <script src="{{asset('js/guest/plugin/lazyload.js')}}"></script>
    ...
    <!-- Font Aweseome -->
    <script defer="" src="{{asset('js/guest/plugin/all.js')}}"></script>
...
<body id="suplo-car-cua-hang-phu-kien-do-choi-noi-that-xe-hoi-chinh-hang" class="@yield('body.class_body',"template-index")">
    ...
    <script defer="" src="{{asset('js/guest/plugin/fastclick.min.js')}}"></script>
    <script defer="" src="{{asset('js/guest/plugin/script.js')}}"></script>
